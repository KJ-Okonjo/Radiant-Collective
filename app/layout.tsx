...
const siteUrl = 'https://radiantcollective.com'

export const metadata: Metadata = {
  metadataBase: new URL(siteUrl),
  title: 'Radiant Collective | The Leadership Mastermind Experience — Johannesburg',
  ...
  icons: {
    icon: '/assets/images/logos/radiantlogoicongold.png',
  },
  openGraph: {
    title: 'Radiant Collective | Leadership Mastermind — Johannesburg 2026',
