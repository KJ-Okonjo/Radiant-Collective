    ...
    <section className="curators" id="mastermind">
      <div className="container">
        <div ref={ref} className={`curators__inner animate-fade-up ${isVisible ? 'is-visible' : ''}`}>
          ...
          <h2 className="h2 curators__title">The Radiant Leadership Playbook</h2>
          <p className="curators__text">
            Anchored by the Radiant Leadership Playbook — a leadership blueprint designed by Udo Okonjo — this mastermind is built for depth, not performance. Every session translates lived leadership experience into shared mastery.
          </p>
          <p className="curators__text">
        ...
        <div ref={ref} className={`founder__wrapper animate-fade-up ${isVisible ? 'is-visible' : ''}`}>
          ...
          <div className="founder__content">
            ...
            <p className="founder__text">
              Udo Okonjo is the founder and convener of Radiant Collective. A lawyer, executive coach, investor, and Chief Executive Officer of Fine and Country West Africa, she has spent more than two decades building leadership and wealth ecosystems for women across Africa and the diaspora.
            </p>
            <p className="founder__text">
              Radiant Collective represents the culmination of her work across leadership development, capital formation, and legacy building. Her work continues to shape how accomplished African women think about influence, scale, ownership, and long-term impact.
            </p>
          </div>
        </div>
      </div>
    ...
    <section className="legacy">
      <div className="container">
        <div ref={ref} className={`legacy__wrapper animate-fade-up ${isVisible ? 'is-visible' : ''}`}>
          <p className="overline legacy__overline">About Radiant Collective</p>
...
function EventsSection() {
  ...
  const events: Array<{
  ...
  }> = [
    {
      ...
      price: '$275 – $550',
      desc: 'A Private Strategic Room for Women Building What Comes Next. You will leave with clarity on your leadership brand, your personal Wealth Blueprint, your bold next move, and a 90-Day Action Plan. You become part of the Radiant Collective Circle — a cross-border community committed to peer-to-peer exchange and accountability that doesn\'t end when the room closes.',
      cta: null,
    },
    {
      id: 'lagos',
      ...
      spots: null,
      price: null,
      desc: 'The inaugural Radiant Collective Leadership Mastermind brought together accomplished women leaders for two transformative days of wealth strategy, leadership mastery, and intentional living. A curated room for women operating at scale or preparing for it.',
      cta: null,
    },
  ]
    ...
    <section className="events-section" id="events">
      <div className="container">
        <div ref={ref} className={`events__wrapper animate-fade-up ${isVisible ? 'is-visible' : ''}`}>
          ...
          <h2 className="h2 events__title">Radiant Collective Masterminds</h2>
      ...
      <div className="container">
        <div className="footer__top">
          <div className="footer__brand">
            <a href="#" className="footer__logo">Radiant Collective</a>
        ...
        <div className="footer__bottom">
          <p className="footer__copyright">&copy; 2026 Radiant Collective. All rights reserved.</p>
